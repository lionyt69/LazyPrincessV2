...
# Bot information
SESSION = environ.get('SESSION', 'Cineflix')
API_ID = int(environ.get('API_ID', '16815512
'))
API_HASH = environ.get('API_HASH', '675e20a6336770f8d8fd5fc690e9ffb6')
BOT_TOKEN = environ.get('BOT_TOKEN', "6829814728:AAFdQAQ0JSDb4V5JQsuxoSnZ3xE7M_1_TZs")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5161032736' '5492650308').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001620891165').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5492650308').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1002049786524')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Cineflix")
...
DOWNLOAD_TEXT_URL = "https://t.me/cineflix69"

   # Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/cineflix69"
